...
class ExportStudentsView(View):
    ...
    def get(self, request):
        ...
        response[
            'Content-Disposition'] = f'attachment; filename="StudentsExport-{today.strftime("%b-%d-%Y")}.csv"'  # noqa

        writer = csv.writer(response)
        writer.writerow(['First name', 'Last name', 'Age', 'Mobile'])
...
class JSApiView(TemplateView):
    template_name = 'jsapi.html'


class JQApiView(TemplateView):
    template_name = 'jquerysapi.html'
